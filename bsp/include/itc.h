 ...
 */
void itc_set_handler (itc_src_t src, itc_handler_t handler);
 ...
 */
void itc_set_priority (itc_src_t src, itc_priority_t priority);
 ...
 * @param src		Identificador de la fuente
 */
void itc_enable_interrupt (itc_src_t src);
 ...
 * @param src		Identificador de la fuente
 */
void itc_disable_interrupt (itc_src_t src);
 ...
 * @param src		Identificador de la fuente
 */
void itc_force_interrupt (itc_src_t src);
 ...
 * @param src		Identificador de la fuente
 */
void itc_unforce_interrupt (itc_src_t src);
